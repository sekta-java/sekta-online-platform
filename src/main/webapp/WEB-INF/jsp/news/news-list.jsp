...
<div class="create-button">
    <button type="button" class="btn btn-primary col-xs-2" data-toggle="modal" data-target="#myModal">New news</button>
</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/news/create" method="post" class="">
...
<table class="table table-striped text-center all-items">
<c:forEach items="${news}" var="novelty">
    <tr>
        <td>${novelty.text}</td>
        <td>${novelty.releaseDate}</td>
        <td><a href="/users/edit/${novelty.id}"><i class="glyphicon glyphicon-pencil" style="color: #d9b144;"></i></a></td>
        <td>
