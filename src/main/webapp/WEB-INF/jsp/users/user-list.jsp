...
<t:template>
    <jsp:body>
        ...
        <div class="create-button">
            <button type="button" class="btn btn-primary col-xs-2" data-toggle="modal" data-target="#myModal">New user
            </button>
        </div>
        ...
        <table class="table table-striped text-center list-items table-hover">
            ...
            <c:forEach items="${users}" var="user">
                <tr>
                    ...
                    <td>${user.email}</td>
                    <td>
                        <a href="/users/${user.userId}/edit"><i class="glyphicon glyphicon-pencil"
                                                                style="color: #d9b144;"></i></a>
                    </td>
                    <td>
